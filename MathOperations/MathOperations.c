...
/**************************************************************************************************\
   INLINE_FCN: inlined function(s)
\**************************************************************************************************/
static void Sa2_Subtract(void);
...
static void Sa2_Subtract(void)
{
   /* Sum: MathOperations/Subtract/Subtract */
   Sa2_Subtract_a = (Int16) (Sa1_In2 - 1);
}
