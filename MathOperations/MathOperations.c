 ...
 *** Generation date: 2024-06-09 02:09:01
 ***
...
\**************************************************************************************************/
UInt8 Input; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 10 */
...
\**************************************************************************************************/
static Int16 Sa3_Sum(Int16 Sa3_InPort);
...
void MathOperations(void)
{
   /* TargetLink outport: MathOperations/OutPort
      ...
      # combined # call of function: MathOperations/Sum
      # combined # update(s) for inport MathOperations/Sum/InPort */
   Sa1_OutPort = Sa3_Sum((Int16) GetInput()) * ((Int16) (Sa1_In2 - 1));
}
...
static Int16 Sa3_Sum(Int16 Sa3_InPort)
{
   /* # combined # TargetLink outport: MathOperations/Sum/OutPort
      # combined # Sum: MathOperations/Sum/Sum */
   return ((Int16) (Sa3_InPort + 1));
}
