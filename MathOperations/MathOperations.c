 ...
 *** Generation date: 2024-06-08 23:03:30
 ***
...
\**************************************************************************************************/
static void Sa3_Sum(Int16 * Sa3_OutPort);
...
void MathOperations(void)
{
   ...
   /* update(s) for inport MathOperations/Sum/InPort */
   Sa3_InPort = Sa1_In1;
   ...
   Sa1_OutPort = Sa3_OutPort * ((Int16) (Sa1_In2 - 1));
}
...
static void Sa3_Sum(Int16 * Sa3_OutPort)
{
   /* TargetLink outport: MathOperations/Sum/OutPort
      # combined # Sum: MathOperations/Sum/Sum */
   *Sa3_OutPort = (Int16) (Sa3_InPort + 1);
}
